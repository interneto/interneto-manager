<x-layout-home>
    <div class="container px-4 py-5" id="hanging-icons">
        ...
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
            ...
            <ul>
                <li class="nav-item"><a href="https://github.com/interneto/interneto-manager/archive/refs/heads/main.zip" class="nav-link px-2 text-muted">Download Interneto manager</a></li>
            </ul>
        </div>
    </div>
